...
nat_comm_D0 <- agg_genus_data_D3 %>% 
  ...
  theme_minimal() +
    ...
    labs( y = "Relative Abundance (Genus)", x = "Genus", fill = 'Pond Community Day 0',
          title = "Rank Abundance Curve Based on 16S v4 Tag Sequencing of Initial Pond Communities") +
...
ggsave(filename = "Isolates D3-D31 Phycosphere Comparison.png",  dpi = 300, path = "./figures", width = 15, height = 20)
